...
import io.github.codecraft87.eshop.payment.common.enums.PaymentMode;
...
public class PaymentService implements PaymentModuleService {
  ...
  private Payment getPaymentById(long paymentId) {
    final Payment payment = paymentRepo.findById(paymentId).orElseThrow(() -> new PaymentNotFoundException(paymentId));
